...
class foldersTableFunctions:
    ...
    def folderIDAvailable(newID):
        ...
        retrievedID = cur.execute("SELECT folderID FROM folders WHERE folderID='{}'".format(newID))#Queries database for folderID, stores in variable retrievedID
        retrievedID = generalDbFunctions.tupToString(retrievedID)#Data from db will be returned as tuple, tuple needs to be converted to int to be compared.
...
print(foldersTableFunctions.returnFolders("newUsername"))
