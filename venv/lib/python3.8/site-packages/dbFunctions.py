...
class articlesTableFunctions:
    ...
    articleID integer,
                ...
                articleFolderIn int,
    """
    def editArticle(articleTitle,articleKeyWords,articleNotes,articleSummary,articleFolderIn):
        con = sqlite3.connect('users.db') #Establishes connection to the Database
        cur = cur.cursor()
...
folderID = 8640145321777
articleName = "Quantum"
articleId = articlesTableFunctions.returnArticleID(articleName,folderID)

print(articlesTableFunctions.returnArticleKeyWords(articleId))
print(articlesTableFunctions.returnArticleNotes(articleId))
